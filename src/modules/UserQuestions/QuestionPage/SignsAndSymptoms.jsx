...
export const SignsAndSymptoms = ({ toNextQuestion, setToNextQuestion, setAnswer, answer }) => {
	const handleChange = (event) => {
		setAnswer({...answer, q4: event.target.value})
	}
	return (
		<Stack sx={questionStyle.body}>
			<Stack sx={questionStyle.innerBody}>
				<Stack direction='row'>
					...
					<Stack>
						<Typography variant="body/1">Do you have signs and symptoms?</Typography>
						<Typography variant="info"><i>*if yes, please indicate signs and symptoms</i></Typography>
					</Stack>
				</Stack>
